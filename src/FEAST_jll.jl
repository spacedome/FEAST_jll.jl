...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FEAST_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4f9e5309-369a-58e7-ade9-f1b0b0d033a8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FEAST", artifacts_toml) for e in artifacts["FEAST"]]
...
if best_platform === nothing
    @debug("Unable to load FEAST; unsupported platform $(triplet(platform_key_abi()))")
else
